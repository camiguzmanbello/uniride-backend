...
class EditarPerfilSerializer(serializers.ModelSerializer):
    ...
    def validate_phone(self, value):
        ...
        if user_qs.filter(phone=value).exists():
            raise serializers.ValidationError("Ese número de teléfono ya está en uso por otro usuario.")

        # Validar duplicados en PendingUser
        if PendingUser.objects.filter(phone=value).exists():
            raise serializers.ValidationError("Ese número de teléfono ya está en uso por un usuario pendiente.")
